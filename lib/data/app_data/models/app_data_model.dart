...
//<editor-fold desc="Data Methods">
  ...
  factory AppDataModel.fromJson(Map<String, dynamic> map) {
    return AppDataModel(
      ...
      bucketUrl: map['bucketUrl'] == null ? null : map['bucketUrl'] as String,
      ...
      cloudUrl: map['cloudUrl'] == null ? null : map['cloudUrl'] as String,
      purchaseCallbackUrl: map['purchaseCallbackUrl'] == null ? null : map['purchaseCallbackUrl'] as String,
      kvkkPrivacyPolicyEn: map['kvkkPrivacyPolicyEn'] == null ? null : map['kvkkPrivacyPolicyEn'] as String,
      kvkkPrivacyPolicyTr: map['kvkkPrivacyPolicyTr'] == null ? null : map['kvkkPrivacyPolicyTr'] as String,
      onlineSalesAgreementEn: map['onlineSalesAgreementEn'] == null ? null : map['onlineSalesAgreementEn'] as String,
      onlineSalesAgreementTr: map['onlineSalesAgreementTr'] == null ? null : map['onlineSalesAgreementTr'] as String,
      userConsentConfirmationFormEn:
      map['userConsentConfirmationFormEn'] == null ? null : map['userConsentConfirmationFormEn'] as String,
      userConsentConfirmationFormTr:
      map['userConsentConfirmationFormTr'] == null ? null : map['userConsentConfirmationFormTr'] as String,
      userAgreementsEn: map['userAgreementsEn'] == null ? null : map['userAgreementsEn'] as String,
      userAgreementsTr: map['userAgreementsTr'] == null ? null : map['userAgreementsTr'] as String,
      personalDataProtectionEn: map['personalDataProtectionEn'] == null ? null : map['personalDataProtectionEn'] as String,
      personalDataProtectionTr: map['personalDataProtectionTr'] == null ? null : map['personalDataProtectionTr'] as String,

      basketShippingFee: map['basketShippingFee'] == null ? null : map['basketShippingFee'] as double,
      basketShippingNoFeeLimit: map['basketShippingNoFeeLimit'] == null ? null : map['basketShippingNoFeeLimit'] as double,

      basketItemCounterLimit: map['basketItemCounterLimit'] == null ? null : map['basketItemCounterLimit'] as int,

      kdvTaxPercentage: map['kdvTaxPercentage'] == null ? null : map['kdvTaxPercentage'] as int,
