...
import 'home_birth_date_form.dart';

class HomeBirthDatePage extends StatelessWidget {
  final UserYorshoEntity userYorshoEntity;

  const HomeBirthDatePage({required this.userYorshoEntity, super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<HomeBirthDateBloc>(
      create: (_) => Injector.instance<HomeBirthDateBloc>()
        ..add(HomeBirthDateEventFetched(
  ...
  _build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context)!.translate('birth_date')!),
      ),
      body: Container(
  ...
  _buildMain(BuildContext context) {
    return HomeBirthDateForm(userYorshoEntity: userYorshoEntity);
  }
