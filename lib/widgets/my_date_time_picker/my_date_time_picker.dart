...
import 'my_date_time_picker_theme.dart';
...
class MyDateTimePicker extends StatefulWidget {
  MyDateTimePicker({
    ...
    this.pickerTheme = MyDateTimePickerTheme.Default,
    this.onCancel,
    this.onChange,
    this.onConfirm,
    this.looping = false,
  ...
  final MyDateTimePickerTheme? pickerTheme;
...
class _DateTimePickerState extends State<MyDateTimePicker> {
  ...
  _DateTimePickerState(
    ...
    this._minDateTime = widget.firstDate ?? DateTime.parse(DATE_PICKER_MIN_DATETIME);
    this._maxDateTime = widget.lastDate ?? DateTime.parse(DATE_PICKER_MAX_DATETIME);
  ...
  Widget _renderDatePickerWidget() {
    ...
    formatArr.forEach((format) {
      ...
      Widget pickerColumn = _renderDatePickerColumnComponent(
        ...
        fontFamily: widget.pickerTheme!.itemTextStyle.fontFamily
      );
  ...
  Widget _renderDatePickerItemComponent(
      int value, String format, double? fontSize, String? fontFamily) {
    ...
    return Container(
      ...
      child: AutoSizeText(
        ...
        style: TextStyle(
            ...
            fontFamily: fontFamily ?? widget.pickerTheme!.itemTextStyle.fontFamily
        ),
