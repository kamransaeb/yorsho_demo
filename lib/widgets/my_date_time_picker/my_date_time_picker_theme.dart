...
//const double DATETIME_PICKER_HEIGHT = 220.0;

/// Default value of DatePicker's title height.
const double DATETIME_PICKER_TITLE_HEIGHT = 28.0;

/// Default value of DatePicker's column height.
const double DATETIME_PICKER_ITEM_HEIGHT = 25.0;

/// Default value of DatePicker's item [TextStyle].
const TextStyle DATETIME_PICKER_ITEM_TEXT_STYLE =
const TextStyle(color: AppTheme.iconColor, fontSize: 18.0, fontFamily: 'Asap', fontWeight: FontWeight.bold,);

const Color DATETIME_PICKER_ITEM_TEXT_COLOR = AppTheme.iconColor;
const double DATETIME_PICKER_ITEM_TEXT_SIZE_SMALL = 16;
const double DATETIME_PICKER_ITEM_TEXT_SIZE_BIG = 20;

/// To support both stable and beta channels until
/// 'DiagnosticableMixin' is officially deprecated.
class MyDateTimePickerTheme {
  ...
  static const MyDateTimePickerTheme Default =  MyDateTimePickerTheme();
